...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("˹ ᴄσηᴛᴧᴄᴛ ˼", url="http://t.me/iTzAvengers")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("˹ sυᴘᴘσʀᴛ ˼", url="https://t.me/+ijVUQc7TNEUwNmNl"),
            InlineKeyboardButton("˹ υᴘᴅᴧᴛєs ˼", url="https://t.me/ShiriUpdate"),
        ],
        [
