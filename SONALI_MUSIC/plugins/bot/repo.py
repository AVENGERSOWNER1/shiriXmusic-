...
✼ || [˹ᴧᴠєɴɢєʀs ɴᴇᴛᴡσʀᴋ˼](https://t.me/AvengersNetwork) ||
...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("• ʜєʟᴘ •", url="https://t.me/ShiriUpdate"),
          InlineKeyboardButton("• 𝛅ᴜᴘᴘσʀᴛ •", url="https://t.me/+ijVUQc7TNEUwNmNl"),
          ],
[
InlineKeyboardButton("• ϻᴧɪη ʙσᴛ •", url=f"https://t.me/ShiriMusicBot"),
