...
OWNER_USERNAME = getenv("OWNER_USERNAME","iTzAvengers")
BOT_USERNAME = getenv("BOT_USERNAME" , "ShiriMusicbot")
BOT_NAME = getenv("BOT_NAME" , "sʜɪꝛɪ мυѕιᴄ")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/AVENGERSOWNER1/shiriXmusic-",)
